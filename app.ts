...
function defaultScene(): rt.Scene {
    return {
        things: [new rt.Plane(new rt.Vector(0.0, 1.0, 0.0), 0.0, Surfaces.checkerboard),
                 new rt.Moving(new rt.Vector(0.0, 1.0, -0.25), 1.0, Surfaces.shiny),
...
function differentScene(): rt.Scene {
    return {
        things: [new rt.Plane(new rt.Vector(0.0, 1.0, 0.0), 0.0, Surfaces.checkerboard),
                       new rt.Moving(new rt.Vector(0.0, 1.0, -0.25), 1.0, Surfaces.shiny),
                     ],
              lights: [{ pos: new rt.Vector(-2.0, 2.5, 0.0), color: new rt.Color(0.9, 0.7, 0.7) },
                       { pos: new rt.Vector(1.5, 2.5, 1.5), color: new rt.Color(0.7, 0.07, 0.49) },
                       { pos: new rt.Vector(1.5, 2.5, -1.5), color: new rt.Color(0.7, 0.4, 0.07) },
                       { pos: new rt.Vector(2.5, 1.5, -1.5), color: new rt.Color(0.7, 0.4, 0.07) },
                       { pos: new rt.Vector(0.0, 3.5, 0.0), color: new rt.Color(0.2, 0.21, 0.35) }],
              camera: new rt.Camera(new rt.Vector(5.0, 6.0, 5.0), new rt.Vector(-1.0, 0.5, 0.0))
    };
}
...
function exec() {
    ...
    // >>> End: THIS WILL GO AWAY in your solution, if you add motion blur

    // start the raytracer
    // rayTracer.render(4, scene, length, fps, updateScene, ctx, 640, 480, 640, 480, false);
    rayTracer.render(4, scene, length, fps, updateScene, ctx, 640, 480, 640, 480, true); //uncomment this for motion blur
    // rayTracer.render(4, dScene, length, fps, updateScene, ctx, 640, 480, 640, 480, false); // uncomment this for a different scene
}
