...
export class Plane {
    constructor(norm, offset, surface) {
        ...
        this.intersect = function (time, ray) {
...
export class RayTracer {
    ...
    shade(time, isect, scene, depth) {
        var d = isect.ray.dir;
        var pos = Vector.plus(Vector.times(isect.dist, d), isect.ray.start);
        var normal = isect.thing.normal(pos);
        var reflectDir = Vector.minus(d, Vector.times(2, Vector.times(Vector.dot(normal, d), normal)));
        var naturalColor = Color.plus(Color.background, this.getNaturalColor(time, isect.thing, pos, normal, reflectDir, scene));
    ...
    getNaturalColor(time, thing, pos, norm, rd, scene) {
    ...
    //    of frames
    render(grid, scene, length, fps, updateScene, ctx, screenWidth, screenHeight, canvasWidth, canvasHeight, motionBlur) {
